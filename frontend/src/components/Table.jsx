...
const Table = () => {
    ...
    // const mobile-view-table-heading-style = 'lg:hidden absolute top-0 left-0 bg-blue-200 px-3 py-1 text-xs font-bold uppercase'
                        ...
                        apidata.map((item, index) => {
                            return (
                                <tr className="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0" key={index}>
                                    <td className="each-table-cell-style">
                                        <span className="mobile-view-table-heading-style">Sn.</span>
                                        {++index}
                                    </td>
                                    <td className="each-table-cell-style">
                                        <span className="mobile-view-table-heading-style">Title</span>
                                        {item.title}
                                    </td>
                                    <td className="each-table-cell-style">
                                        <span className="mobile-view-table-heading-style">Description</span>
                                        {item.description}
                                    </td>
                                    <td className="each-table-cell-style">
                                        <span className="mobile-view-table-heading-style">Status</span>
                                        {(item.status ?
                                    ...
                                    <td className="w-full lg:w-auto px-5 py-7 lg:py-3 text-gray-800 text-center border border-b block lg:table-cell relative lg:static">
                                        <span className="mobile-view-table-heading-style">Actions</span>
