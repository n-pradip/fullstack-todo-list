    ...
    return (
        <div className="container mx-auto my-10 px-10 sm:px-10 md:px-20 lg:px-0">
            <table className="border-collapse w-full">
                <thead>
                    <tr>
                        <th className="p-3 font-semibold uppercase bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell">Sn.</th>
                        <th className="p-3 font-semibold uppercase bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell">Title</th>
                        <th className="p-3 font-semibold uppercase bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell">Description</th>
                        <th className="p-3 font-semibold uppercase bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell">Status</th>
                        <th className="p-3 font-semibold uppercase bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell">Actions</th>
                    </tr>
                </thead>
                <tbody>
                    {
                            ...
                            return (
                                <tr className="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0" key={index}>
                                    <td className="w-full lg:w-auto px-5 py-6 lg:py-3 text-gray-800 text-center border border-b block lg:table-cell relative lg:static">
                                        <span className="lg:hidden absolute top-0 left-0 bg-blue-200 px-3 py-1 text-xs font-bold uppercase">Sn.</span>
                                        {++index}
                                    </td>
                                    <td className="w-full lg:w-auto px-5 py-6 lg:py-3 text-gray-800 text-center border border-b block lg:table-cell relative lg:static">
                                        <span className="lg:hidden absolute top-0 left-0 bg-blue-200 px-3 py-1 text-xs font-bold uppercase">Title</span>
                                        {item.title}
                                    </td>
                                    <td className="w-full lg:w-auto px-5 py-6 lg:py-3 text-gray-800 text-center border border-b block lg:table-cell relative lg:static">
                                        <span className="lg:hidden absolute top-0 left-0 bg-blue-200 px-3 py-1 text-xs font-bold uppercase">Description</span>
                                        {item.description}
                                    </td>
                                    <td className="w-full lg:w-auto px-5 py-7 lg:py-3 text-gray-800 border border-b text-center block lg:table-cell relative lg:static">
                                        <span className="lg:hidden absolute top-0 left-0 bg-blue-200 px-3 py-1 text-xs font-bold uppercase">Status</span>
                                        {(item.status ?
